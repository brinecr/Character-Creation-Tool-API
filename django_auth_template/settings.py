"""
Django settings for monster-fighting-simulator project.
...
ROOT_URLCONF = 'monster-fighting-simulator.urls'
...
WSGI_APPLICATION = 'monster-fighting-simulator.wsgi.application'
